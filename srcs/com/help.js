...
enyo.kind({
	...
	components: [
		{ tag: "ul", components: [
			{ tag: "li", content: "To create a new tournament, press the plus icon in the top right corner of the screen." },
...
enyo.kind({
	...
	components: [
		{ tag: "dl", components: [
			...
			{ tag: "dd", allowHtml: true, content: "A: This is a <b>virtual tournament app</b>. It allows you to " + 
				"create a tournament in which one person plays against another person, in real life, using an Xbox, PS3, Wii, or any other current " + 
				"or last generation gaming console. The user creates a new tournament, and then plays the games on an actual gaming device against their real-life " + 
			...
			{ tag: "dt", content: "Q: Why can't I play more games in an NFL round?" },
			{ tag: "dd", content: "A: The NFL playoff format has never allowed for more than 1 game per round. This will not change." },
			...
			{ tag: "dd", content: "A: In tournaments, typically two people will play each other in games. It would be impossible for one person to play as both teams in a video game. " + 
				...
				"To change a user, simply tap on the coloured circle next to the user's name and select the opposite user for that team. That user will then control that team throughout the remainder of their playoff run." },
		]}
	],
	create: function(){
		this.inherited(arguments);
