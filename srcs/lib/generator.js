...
enyo.kind({
	...
	components: [
		{ name: "hbox", kind: "Scroller", horizontal: "scroll", vertical: "auto", strategyKind: "ScrollStrategy", layoutKind: "FittableColumnsLayout", classes: "center enyo-fit", components: [
			...
			{ kind: "Scroller", layoutKind: "FittableRowsLayout", components: [
				{ kind: "setup", onGenerate: "generate", onColorChange: "colorChange", onSportTap: "sportTap", onUserChange: "userChanged", onRandomize: "randomize" },
			]},
	...
	create: function(){
		...
		this.$.setup.$.sport.active.bubble("ontap");
	...
	sportTap: function(inEvent, inSender){
		this.setSport(inSender.active.content);
	},
