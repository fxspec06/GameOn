...
enyo.kind({
	...
	components: [
		...
		{ kind: "FittableColumns", fit: true, components: [
			 ...
			 * app goes here
			 */
				{ name: "generator", kind: "generator", fit: true, showing: false, onGenerate: "generate" },
		...
		{ kind: "help" },
		{ kind: "onyx.Toolbar", onmousedown: "slide", ondrag: "slide", style: "height: 58px;", components: [
	...
	showKind: function(inEvent, kind, activate){
		...
		if(activate!=null)this.$[kind].activate(activate);
		this.$[kind].render();
	...
	createTournament: function(inEvent){
		if ( this.kind == "bracket" && this.$.bracket.saved == false ) {
			...
			this.showKind(inEvent, "generator");
		}
	},
